...
import { FadeIn, ScrollReveal, ScaleOnScroll } from "@/components/animations";
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="dark relative min-h-[80vh] flex items-center justify-center bg-background text-foreground">
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <FadeIn y={80} delay={0.2}>
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight">
                Ludhiana&apos;s #1 Doorstep Car Wash
              </h1>
            </FadeIn>

            <FadeIn y={60} delay={0.4}>
      ...
      <section className="py-20 bg-accent text-accent-foreground">
        <div className="container mx-auto px-4">
          ...
          <ScrollReveal stagger={0.15} childSelector=".comparison-column">
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto text-foreground">
              <div className="comparison-column space-y-6">
      ...
      <section id="how-it-works" className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <ScrollReveal stagger={0.2} childSelector=".process-card">
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <Card className="process-card text-center">
                <CardHeader>
              ...
              <Card className="process-card text-center">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Our fully equipped van arrives. You don&apos;t even need to
                    be there.
                  </p>
                </CardContent>
              </Card>
      ...
      <section id="pricing" className="py-20 bg-accent text-accent-foreground">
        <div className="container mx-auto px-4">
          ...
          <ScrollReveal stagger={0.2} childSelector=".pricing-card">
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-8">
              {/* Starter Plan */}
              <Card className="pricing-card border-2">
                <CardHeader>
              ...
              {/* Recommended Plan */}
              <Card className="pricing-card border-4 border-primary relative shadow-xl">
            ...
            <Card className="max-w-3xl mx-auto my-12 border-2">
              <CardContent className="pt-6">
                ...
                <p className="text-lg italic text-center mb-4">
                  &quot;I used to waste my Sunday morning at the wash center.
                  Now Karwsh does it while I have breakfast.&quot;
                </p>
